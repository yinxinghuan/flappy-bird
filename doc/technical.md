...
- 平台元信息：meta.title=Flappy Bird；category=action；uuid=de6a8562-2aa1-44b6-a360-45850fcfc9f7
...
- `src/FlappyBird/FlappyBird.tsx`
- `src/FlappyBird/FlappyBird.less`
- `src/FlappyBird/types.ts`
- `src/FlappyBird/index.ts`
- `src/FlappyBird/utils/sounds.ts`
- `src/FlappyBird/components/SplashScreen.tsx`
